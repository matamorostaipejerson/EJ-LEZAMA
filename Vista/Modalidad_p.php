...
<body style="background-image: url('img/fondo_duotono.jpg')">
    ...
    <span style="text-align:center;font-family:Impact;"><h2>PROCESO PENAL</h2></span>
	<div class="container">
        <button class="btn btn-primary my-5"><a href="Modalidad_agrega.php?idproceso=13" class="text-light">Añadir Expediente</a>
        </button>
        <!-- <button class="btn btn-secondary"><a href="Modalidad_historial.php" class="text-light">Historial Usuario</a>
        </button> -->
        <button class="btn btn-secondary"><a href="Modalidad_historial.php" class="text-light">Historial Usuario</a>
        </button>
        <img src="img/penal.png"/>
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM `expediente` WHERE idProceso='13'"; 
