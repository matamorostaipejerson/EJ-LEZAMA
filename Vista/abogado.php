...
<head>
  ...
  <link href="css/abogado.css" rel="stylesheet" />
...
<body>
  <header>
    <div class="row">
      ...
      <div class="col-sm">
        <p class="titulo1" style="margin-top: 25px; font-size: 23px;margin-left:-60px;   color: white;;">ESTUDIO JURÍDICO LEZAMA - ABOGADO</p>
      </div>
      <div class="col-sm">
        <i class="fas fa-user"></i>&nbsp;
        <a target="_blank" style="color: white;" href="Perfil.php?var1=abogado&var2=admin">PERFIL ABOGADO</a>
      </div>
    </div>
  </header>
  <section class="contenido">
    <div id="contenedor">
      <div class="left-section">
        <img class="abogado" src="img/abogado.png">
        <ul class="navegador">
              ...
              <div class="modal-body">
                <table style="border: 10px;">
                  ...
                  <tr>
                    ...
                    <td><input type="text" id="txtTitulo" placeholder="ingresa según la importancia"/></td>
                  </tr>
                  <tr>
