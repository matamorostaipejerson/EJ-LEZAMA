...
<body style="background-image: url('img/fondo_duotono.jpg')">
    ...
    <span style="text-align:center;font-family:Impact;"><h2>PROCESO LABORAL</h2></span>
	<div class="container">
        <button class="btn btn-primary my-5"><a href="Modalidad_agrega.php?idproceso=12" class="text-light">Añadir Expediente</a>
        </button>
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM `expediente` WHERE idProceso='12'"; 
